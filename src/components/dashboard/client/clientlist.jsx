...
const Clientlist = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const clientsResponse = await fetch('https://localhost:8000/api/v1/advisor/list-of-clients', {
          method: 'GET',
          headers: {
        ...
        const plansResponse = await fetch('https://localhost:8000/api/v1/advisor/list-of-plans', {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
          },
