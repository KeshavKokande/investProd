...
function StockTable({ data, type, title, w, h, getTrendingStocks, buttonSelected, watchlist, setWatchlist, setSearchResults, setIsSearching }) {
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Box
                                                        ...
                                                        fontWeight='600'
                                                    >
                                                        {stock.PriceChange.includes('-')  }{stock.PriceChange}
                                                    </Box>
                                                    <Box
                                                        w='70px'
                                                        gap='10px'
