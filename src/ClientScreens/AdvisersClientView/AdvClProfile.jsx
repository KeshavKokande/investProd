...
function AdvClProfile() {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const advisorsResponse = await fetch(`https://localhost:8000/api/v1/Client/get-all-advisors`, {
            method: 'GET',
            headers: {
          ...
          const plansResponse = await fetch(`https://localhost:8000/api/v1/Client/get-all-plans`, {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
            },
          ...
          const clientDetailsResponse = await fetch(`https://localhost:8000/api/v1/Client/get-own-details`, {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
            },
