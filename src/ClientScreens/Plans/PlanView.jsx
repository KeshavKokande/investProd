...
//       setInvestmentError('Invested amount cannot be less than minimum investment amount.');

//       return;

//     }
 
//     // Proceed with buying the plan if validation passes
...
//             <img src={dummy} className={styles.planImage} alt="Plan" />
...
//                 <p className={styles.rowLabel}>Advise</p>

//                 <p className={styles.rowValue}>{plan.advise}</p>

//               </div>

//               <div className={styles.row}>

//                 <p className={styles.rowLabel}>Cap Value</p>

//                 <p className={styles.rowValue}>{plan.capValue}</p>

//               </div>

//               {/* Other plan information rows */}
...
//               {investmentError && <div className={styles.error}>{investmentError}</div>}
