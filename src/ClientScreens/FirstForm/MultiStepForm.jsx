...
const MultiStepForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(`https://localhost:8000/api/v1/client/register-client`, {
        method: 'POST',
        headers: {
      ...
      navigate('/client_dashboard'); // Navigate to '/client_dashboard' if registration is successful
