...
const PageThree = ({ agreed, handleCheckboxChange }) => {
        ...
        <div className={styles.preStyle}>
          ...
          <div className={styles.termsconditions}>
            <pre prestyle={styles.preStyle}>
              {`  Welcome to our Investment Advisory Portal! Before you proceed,
  please take a moment to review the following terms and conditions governing 
  your use of our services.
            
  Acceptance of Terms
  By accessing or using our Investment Advisory Portal, you agree to comply 
  ...
  or recommendations. The information provided on the portal is not a 
  ...
  By using our Investment Advisory Portal, you acknowledge that you have read, 
  understood, and agree to be bound by these terms and conditions. If you have
  any questions or concerns, please contact us at support@invest.in.
            `}
            </pre>
          </div>
        </div>
